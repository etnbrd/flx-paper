...
The system dequeues this message and dispatch it to the destination fluxion, handler, \circled{3} and \circled{4}.
The fluxion handler sends back a message using the function \texttt{post(<msg>)}, \circled{5}, to be enqueued in the centralized message queue, \circled{6}.
