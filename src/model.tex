...
Fluxions on different workers have different event-loops and heaps ; their communications are serialized, so it is impossible to send heap references.
...
Only one fluxion is executed at once.
