...
This execution model is similar to actors, as the execution container are independent and communicate by messages.
Though the communication are assimilated to stream of messages, similarly to the data-flow programming model.
...
This execution model is also similar to functions, as the execution container contains function to execute at each message reception.
