...
It allows to reason on the throughput of these streams, and to react to load increases \cite{Bartenstein2014}.
...
\begin{bnf*}
  ...
  \bnfprod{fn}         {\bnftd{Imperative language and stream indicators}}\\
\end{bnf*}
...
\nt{I would suggest adding a brief paragraph to introduce Node.js and esprima and maybe move the url of Node.js stated in the footer of the last page to the first page where Node.js is already stated.}
