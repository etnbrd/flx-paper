...
We expect the that the dynamic reorganization of these independent parts in a cluster of machine can help an application to deal with its load, without imposing this disruptive shift of technology.
\end{abstract}