...
We propose a compiler that transforms a Javascript, single-threaded web application into a network of small independent parts communicating by message streams.
...
We successfully transform a web application to parallelize the execution of an independent part.
