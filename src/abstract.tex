...
Our high-level language proposition consists of a compiler to express a web application into a network of \textit{fluxions} and streams, and the according execution model.
\end{abstract}