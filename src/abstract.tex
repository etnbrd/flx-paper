...
To avoid these shifts, we propose a compiler to abstract web applications into a high-level language, allowing code mobility to dynamically cope with audience growth and decrease.
...
The high-level language we propose allows to express these parts and their streams.
