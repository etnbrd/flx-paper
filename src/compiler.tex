...
\nt{Section 3 describing the compiler is very high level and does not discuss in depth how the different steps are implemented in practice.}
...
Therefore, the pipeliner groups all the fluxions sharing this variable within the same tag.
