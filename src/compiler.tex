...
But, this approach is error-prone, and leads to deadlocks and other synchronization problems. \comment{TODO citation needed : threads are a bad idea, or something like this.}
Since 2009, \textit{Node.js}\cite{Dahl} provides a Javascript execution environment for real-time web applications.

\comment{TODO talk about the ascension of Javascript}
...
\comment{TODO remove the next few lines, and talk about turn-based programming instead, and follow with what is a rupture point}
