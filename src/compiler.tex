...
\comment{
The pipeliner step build the contexts of each fluxion.
Explain exactly what goes in the context.
}

\comment{
The source language is a of higher-order.
Variables may contains closures.
This dynamism implies and drive our high-level language to be dynamic as well.
That reflect in the possibility to instantiate new fluxions dynamically.

However, we currently limit this.
}
