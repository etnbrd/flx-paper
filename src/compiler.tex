...
Since 2009, \textit{Node.js} propose an alternative to this model.
...
If this situations aren't resolved, they introduces errors in the compilation result.
...
async_fn(function callback_1(result) {
  b = a;
  
  async_fn(function callback_2(result) {
    b.item = 'changed';
...
Javascript exposes many other features leading to scope leaking.
...
Additionally, it is impossible to stream variables containing closures.
