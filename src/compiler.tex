...
The pipeliner step analyzes the pipeline representation along with a representation of the memory scopes to distribute the shared memory into independent groups of fluxions.
...
\paragraph{Scope}
If a variable is modified inside only one application part, then it can be part of the context of its fluxion.
