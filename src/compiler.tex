...
Javascript is such a language as it is often implemented on top of an event-loop, like in \textit{Node.js}.
...
The compiler extracts an AST with \texttt{esprima} from the source.
