...
% The language proposes both data encapsulation in objects and a threading model that allows the development of parallel applications.
...
To summarize, the source languages we focus on should present higher-order functions and be implemented as an event-loop with a global memory.
...
\subsection{Pipeliner} \label{section:compiler:linker} % TODO change the label
